...
@IonicPage()
@Component({
  selector: 'page-edit-bands-by-fans',
  templateUrl: 'edit-bands-by-fans.html',
})
export class EditBandsByFansPage {
    ...
    let confirm = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'Yes',
          handler: () => {
            this.firebaseService.deleteBandsByFans(this.item.id)
            .then(
